<title>career&amp;training&nbsp;advise</title>
			...
			<form id="formulaires" enctype="multipart/form-data" action="report.php" method="post">
				<fieldset>
						<fieldset><legend>personal informations</legend>
							<img src="images/user_filled_50px.png" alt="user_pic">
							<!--mettre une option permettant de charger une photo personnelle-->
						<ol>
							<li height="50">
								<label style="position:relative; left:0px; padding-bottom:10px;" for="name">family&nbsp;name/Lastname:
								<input width="100" type="text" id="lastname" name="lastname"required="true"></label>
								<label style="position:relative; padding-left:60px;top:-2px;" for="firstname">Firstname:<input type="text" id="name" name="firstname"required="true"></label><br>
								<label style="position:relative; left:155px; top:-23px;">sex<select><option name="sexe" required="true">Mr.</option>
									<option name="sexe" required="true">Mrs.</option>
									<option name="sexe" required="true">Miss.</option></select></label>
										
							   </li>
								<li>
									<label>Age</label>
									<input type="date" name="Age" value="age" required="true">
								</li>
								<li height="50">
				...
				<option value="Zimbabwe">Zimbabwe </option>
								...
								<li>
									<label for="reference">Email of a referee</label>
					...
					<fieldset><legend>complementary informations</legend>
							<ol>
								...
								<lI>
									<label for="renseignement">Add comment</label>
									<p><textarea rows="10" required="true" name="comment"></textarea></p>
								</lI>
							</ol>					
					</fieldset>
							 <span>  
